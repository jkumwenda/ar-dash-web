  ...
  methods: {
    getProject() {
      get(this.$axios, 'project/' + this.$route.params.id + '/')
        .then((result) => {
          this.projectData.project_name = result.project_name
          this.projectData.project_manager = result.project_manager
          this.projectData.client_id = result.client_id
          this.projectData.building_type_id = result.building_type_id
          this.projectData.location_id = result.location_id
          ...
          this.projectData.status_id = result.status_id
        })
        .catch((error) => {
          console.log(error)
        })
    ...
    updateProject() {
      update(
        ...
        .then((results) => {
          this.$router.push('/projects/design')
        })
        .catch((error) => {
          console.log(error)
        })
