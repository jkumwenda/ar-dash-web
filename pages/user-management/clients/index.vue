  ...
  <div class="flex flex-col">
    ...
    >
      ...
      <div class="flex flex-row bg-gray-50 px-5 py-5 hover:bg-gray-200">
        <div class="w-3/12">Joel</div>
        <div class="w-3/12">Kumwenda</div>
        <div class="w-3/12">jkumwenda@gmail.com</div>
        <div class="w-2/12">+265 888 371 088</div>
      ...
      <div class="flex flex-row bg-gray-100 px-5 py-5 hover:bg-gray-200">
        <div class="w-3/12">Kenneth</div>
        <div class="w-3/12">Mlaviwa</div>
        <div class="w-3/12">kmlaviwa@lojiksol.com</div>
        <div class="w-2/12">+265 888 871 088</div>
        <div class="w-1/12 flex flex-col flex-end">
          <!--Dropdown menu-->
          <div class="relative inline-block text-left">
            <div>
