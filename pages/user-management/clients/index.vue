  ...
  <div class="flex flex-col">
    ...
    >
      ...
      <div
        ...
        :key="client.clienta_id"
      >
        <div class="w-3/12">{{ client.user.first_name }}</div>
        <div class="w-3/12">{{ client.user.last_name }}</div>
        <div class="w-3/12">{{ client.user.email }}</div>
        <div class="w-2/12">{{ client.user.username }}</div>
        <div class="w-1/12 flex flex-col flex-end">
          <!--Dropdown menu-->
          <div class="relative inline-block text-left">
            <div>
              <div
                @click="gridOption('grid-data-' + client.client_id)"
            ...
            <div
              ...
              :id="'grid-data-' + client.client_id"
            >
              <div class="py-1">
                <nuxt-link
                  :to="`/user-management/clients/${client.client_id}`"
                  class="
                    text-gray-700
                    block
                    px-4
                ...
                <nuxt-link
                  :to="`/user-management/clients/${client.client_id}/edit`"
                  class="
                    text-gray-700
                    block
                    px-4
...
export default {
  ...
  methods: {
    create() {
      this.$router.push('/user-management/clients/create')
    },
    filter() {
    ...
    edit(client_id) {
      ...
      this.$router.push('/user-management/clients/' + { client_id })
    },
    deleteClient(client_id) {
      destroy(this.$axios, 'client/' + client_id + '/')
        .then((results) => {
