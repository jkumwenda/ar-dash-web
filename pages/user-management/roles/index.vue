  ...
  <div class="flex flex-col">
    ...
    >
      ...
      <div
        ...
        :key="role.role_id"
      >
        <div class="w-11/12">{{ role.role }}</div>
        <div class="w-1/12 flex flex-col flex-end">
          <!--Dropdown menu-->
          <div class="relative inline-block text-left">
            <div>
              <div
                @click="gridOption('grid-data-' + role.role_id)"
            ...
            <div
              ...
              :id="'grid-data-' + role.role_id"
            >
              <div class="py-1">
                <nuxt-link
                  :to="`/user-management/roles/${role.role_id}`"
                  class="
                    text-gray-700
                    block
                    px-4
                ...
                <nuxt-link
                  :to="`/user-management/roles/${role.role_id}/edit`"
                  class="
                    text-gray-700
                    block
                    px-4
...
export default {
  ...
  methods: {
    create() {
      this.$router.push('/user-management/roles/create')
    },
    filter() {
    ...
    edit(role_id) {
      console.log(role_id)
      this.$router.push('/user-management/roles/' + { role_id })
    },
    deleteRole(role_id) {
      destroy(this.$axios, 'role/' + role_id + '/')
        .then((results) => {})
        .catch((error) => {
          console.log(error)
        })
