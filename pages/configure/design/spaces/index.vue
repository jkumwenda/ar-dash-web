  ...
  <div class="flex flex-col">
    ...
    >
      ...
      <div
        ...
        :key="space.space_id"
      >
        <div class="w-11/12">{{ space.space }}</div>
        <div class="w-1/12 flex flex-col flex-end">
          <!--Dropdown menu-->
          <div class="relative inline-block text-left">
            <div>
              <div
                @click="gridOption('grid-data-' + space.space_id)"
            ...
            <div
              ...
              :id="'grid-data-' + space.space_id"
            >
              <div class="py-1">
                <nuxt-link
                  :to="`/configure/design/spaces/${space.space_id}`"
                  class="
                    text-gray-700
                    block
                    px-4
                ...
                <nuxt-link
                  :to="`/configure/design/spaces/${space.space_id}/edit`"
                  class="
                    text-gray-700
                    block
                    px-4
                ...
                <div
                  @click="deleteSpace(space.space_id)"
                  class="
                    text-gray-700
                    block
                    px-4
...
export default {
  ...
  methods: {
    create() {
      this.$router.push('/configure/design/spaces/create')
    },
    filter() {
    ...
    edit(space_id) {
      ...
      this.$router.push('/configure/design/spaces/' + { space_id })
    },
    deleteSpace(space_id) {
      destroy(this.$axios, 'space/' + space_id + '/')
        .then((results) => {})
        .catch((error) => {
          console.log(error)
        })
