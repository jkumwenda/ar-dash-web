<template>
  <div class="flex flex-col">
    <div
      ...
      "
    >
      <div class="text-xl">Building types</div>
    </div>
    ...
    >
      ...
      >
        <div class="w-11/12">Building type</div>
      ...
      >
        <div class="w-11/12">{{ building_type.building_type }}</div>
        <div class="w-1/12 flex flex-col flex-end">
          ...
          <div class="relative inline-block text-left">
            <div>
              <div
                @click="
                  gridOption('grid-data-' + building_type.building_type_id)
                "
            ...
            <div
              ...
              :id="'grid-data-' + building_type.building_type_id"
            >
              <div class="py-1">
                <nuxt-link
                  :to="`/configure/design/building-types/${building_type.building_type_id}`"
                  class="
                    text-gray-700
                    block
                    px-4
                ...
                <nuxt-link
                  :to="`/configure/design/building-types/${building_type.building_type_id}/edit`"
                  class="
                    text-gray-700
                    block
                    px-4
                ...
                <div
                  @click="deleteBuildingType(building_type.building_type_id)"
                  class="
                    text-gray-700
                    block
                    px-4
...
export default {
  ...
  methods: {
    create() {
      this.$router.push('/configure/design/building-types/create')
    },
    filter() {
    ...
    edit(building_type_id) {
      console.log(building_type_id)
      this.$router.push(
        '/configure/design/building-types/' + { building_type_id }
      )
    },
    deleteBuildingType(building_type_id) {
      destroy(this.$axios, 'building_type/' + building_type_id + '/')
        .then((results) => {})
        .catch((error) => {
          console.log(error)
        })
